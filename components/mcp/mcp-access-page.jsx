    ...
    <div className="vaulter-page">
      ...
      <main>
        ...
        <section className="vaulter-section pt-0">
          <div className="mx-auto grid w-full max-w-6xl gap-6 px-6 lg:grid-cols-2 lg:px-8">
            <CommandPanel
              label="Server URL"
            ...
            <CommandPanel
              label="OpenCode"
              title="Exact OpenCode command"
              description="Add Vaulter to OpenCode using the production MCP endpoint."
              code={opencodeCommand}
            />
          </div>
        </section>
